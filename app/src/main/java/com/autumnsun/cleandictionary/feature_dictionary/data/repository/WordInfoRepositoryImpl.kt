package com.autumnsun.cleandictionary.feature_dictionary.data.repository

import com.autumnsun.cleandictionary.core.util.Resource
import com.autumnsun.cleandictionary.feature_dictionary.data.local.WordInfoDao
...
class WordInfoRepositoryImpl(
    ...
    override fun getWordInfo(word: String): Flow<Resource<List<WordInfo>>> = flow {
        ...
        try {
            ...
            emit(Resource.Error(message = "Error, network call!!", data = wordInfos))
        } catch (e: IOException) {
            emit(
                Resource.Error(
